	...
	'jobs': [
		{
			...
			'dates': ['2012', '2013'],
			'description': 'Seguir instrucciones de ingenieros de procesos y complir con objetivos de producción.'
		},
		{
			'employer': 'Diario Provincia 23',
			'title': 'Consultor IT y Diseñador Junior',
			'location': 'Rio Grande, Tierra del Fuego, Argentina',
			'dates': ['2013', '2015'],
			'description': 'Diseñar publicidades para el periódico, asistir en IT (como ser, mantener la red, instalar SO, limpieza de PC).'
		},
		{
